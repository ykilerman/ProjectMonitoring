...
<div class="table-responsive">
    <table class="table table-bordered table-striped table-hover text-center">
        <thead>
            ...
            <td>
                <a onclick="javascript:ajaxLoad('report/listannual?field=updated_at&sort={{Session::get("report_sort")=="asc"?"desc":"asc"}}','data')" href="#">
                    Time
                </a>
            ...
            <td>
                <a onclick="javascript:ajaxLoad('report/listannual?field=name&sort={{Session::get("report_sort")=="asc"?"desc":"asc"}}','data')" href="#">
                    Project Name
                </a>
                <i style="font-size: 12px"
                   class="glyphicon {{ Session::get('report_field')=='updated_at'?(Session::get('report_sort')=='asc'?'glyphicon-sort-by-alphabet':'glyphicon-sort-by-alphabet-alt'):'' }}">
            ...
            <td>
                <a onclick="javascript:ajaxLoad('report/listannual?field=income&sort={{Session::get("report_sort")=="asc"?"desc":"asc"}}','data')" href="#">
                    Income
                </a>
                <i style="font-size: 12px"
            ...
            <td>
                <a onclick="javascript:ajaxLoad('report/listannual?field=expense&sort={{Session::get("report_sort")=="asc"?"desc":"asc"}}','data')" href="#">
                    Expense
                </a>
                <i style="font-size: 12px"
